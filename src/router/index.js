...
const routes = [
  ...
  { path: '/alerts/sin-stock',  component: () => import('../views/AlertCategoryBrands.vue'), meta: { alertType: 'sin-stock' } },
  { path: '/alerts/sin-stock/:brandId', component: () => import('../views/AlertCategoryProducts.vue'), meta: { alertType: 'sin-stock' } },
  { path: '/alerts/stock-bajo',  component: () => import('../views/AlertCategoryBrands.vue'), meta: { alertType: 'stock-bajo' } },
  { path: '/alerts/stock-bajo/:brandId', component: () => import('../views/AlertCategoryProducts.vue'), meta: { alertType: 'stock-bajo' } },
  ...
  { path: '/alerts/:brandId',     redirect: to => `/alerts/sin-stock/${to.params.brandId}` },
  ...
  { path: '/alertas/sin-stock',  redirect: '/alerts/sin-stock' },
  { path: '/alertas/stock-bajo', redirect: '/alerts/stock-bajo' },
  { path: '/alertas/vencimientos', redirect: '/alerts/expiry' },
  { path: '/alertas/:brandId',    redirect: to => `/alerts/sin-stock/${to.params.brandId}` },
