              ...
              >
                ...
                <template v-else>
                  ...
                  <div class="settings-sheet__item-info">
                    ...
                    <span class="settings-sheet__item-meta">{{ getByBrand(brand.id).length === 0 ? 'Sin productos' : getByBrand(brand.id).length === 1 ? '1 producto' : `${getByBrand(brand.id).length} productos` }}</span>
                  </div>
                  <div class="settings-sheet__item-actions">
                    <button
                      class="settings-sheet__action-btn"
