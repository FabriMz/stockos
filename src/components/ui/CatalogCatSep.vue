<template>
        ...
        >
          <div v-if="showMigrate" class="cat-sep-menu__item">
            <button
              ...
              :class="{ 'cat-sep-menu__btn--active': isMigrating }"
              role="menuitem"
      ...
      <Transition name="cat-sep-menu">
        ...
        >
          <input
            :id="`cat-edit-${catId}`"
            :name="`cat-edit-${catId}`"
            class="catalog__cat-edit-input cat-sep-rename-overlay__input"
            v-model="editValue"
            :aria-label="`Renombrar ${catName}`"
            :aria-describedby="editError ? `cat-edit-error-${catId}` : undefined"
            autocomplete="off"
            ref="inputRef"
  ...
  <div
    v-else
    class="catalog__cat-sep"
    :class="{ 'catalog__cat-sep--migrating': isMigrating }"
  >
    <template v-if="isEditing">
      <input
        :id="`cat-edit-${catId}`"
        :name="`cat-edit-${catId}`"
        class="catalog__cat-edit-input"
        v-model="editValue"
        :aria-label="`Renombrar ${catName}`"
        :aria-describedby="editError ? `cat-edit-error-${catId}` : undefined"
        autocomplete="off"
